...
Apache Beam JavaからPythonの処理を呼び出す例について、以前に [Apache Beam Java multi-language pipelines quickstart メモ - zenn](https://zenn.dev/kn1kn1/articles/4aadd3bb4eeb14)で試したが、scikit-learnの処理を呼び出す例がBeamのExampleに追加されていたので試してみた。https://github.com/kn1kn1/beam-example-multi-language-sklern に最終的に動作したプロジェクトを格納した。
...
https://github.com/kn1kn1/beam-example-multi-language-sklern に最終的に動作したプロジェクトを格納した。
